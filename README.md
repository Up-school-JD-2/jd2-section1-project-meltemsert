...
1. **movie.movie sınıfı**: Her bir movie için bir movie.movie sınıfı oluşturun. Bu sınıf, filmin id'sini, filmin başlığını, yönetmenini, oyuncularını, tarihini, açıklamasını, türünü  içermelidir.
...
3. **movie.movie yöneticisi**:  movie.movie sınıfını kullanarak movie eklemek, movie silmek, movie aramak vb. işlemler yapabilecek bir movie.movie Yöneticisi sınıfı oluşturun.
